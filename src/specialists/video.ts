...
Inclua entre 1 e 5 cortes sugeridos.`,
    ...
    private generateASS(
        ...
        const lines: string[] = [
            ...
            'Style: Header,DejaVu Sans,28,&H00FFFFFF,&H000000FF,&H66000000,&H66000000,-1,0,0,0,100,100,0,0,3,1,0,8,20,20,14,1',
            'Style: Subtitle,DejaVu Sans,24,&H00FFFFFF,&H000000FF,&H64000000,&H64000000,0,0,0,0,100,100,0,0,1,2,0,2,28,28,26,1',
            '',
            '[Events]',
