...
var CREDENTIALS_PATH = (0, path_1.join)(process.cwd(), 'data', 'google-oauth-credentials.json');
var TOKEN_PATH = (0, path_1.join)(process.cwd(), 'data', 'google-token.json');
...
function authorize() {
    return __awaiter(this, void 0, void 0, function () {
        var credentials, content, _a, client_secret, client_id, redirect_uris, oAuth2Client, authUrl, rl;
        var _this = this;
        return __generator(this, function (_b) {
            console.log('--- Iniciando Configuração do Google Drive OAuth 2.0 ---');
            try {
                content = (0, fs_1.readFileSync)(CREDENTIALS_PATH, 'utf-8');
            ...
            rl.question('Cole a URL INTEIRA (ou apenas o valor do code=) aqui: ', function (codeSnippet) { return __awaiter(_this, void 0, void 0, function () {
                var code, urlParts, tokens, err_1;
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (code.includes('code=')) {
                                urlParts = new URL(code.startsWith('http') ? code : "http://localhost/?".concat(code));
